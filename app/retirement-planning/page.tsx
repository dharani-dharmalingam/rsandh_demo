    ...
    <div className="space-y-0">
      ...
      <SectionWrapper className="bg-gradient-to-br from-blue-50 to-slate-50">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Retirement Planning</h1>
            <p className="text-lg text-slate-600 mb-4">
              Plan your future with confidence. RS&H offers comprehensive retirement benefits and planning resources
      ...
      <SectionWrapper className="bg-white">
        <h2 className="text-3xl font-bold text-slate-900 mb-12">Retirement Benefits</h2>
      ...
      <SectionWrapper className="bg-slate-50">
        <div className="max-w-3xl">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Planning Your Retirement</h2>
          ...
          <div className="space-y-6 text-slate-700">
            ...
            <div>
              <h3 className="font-semibold text-slate-900 mb-2">Understand Your Options</h3>
              <p>
                Review all available investment options and select a diversified portfolio that aligns with your
                retirement goals and risk tolerance.
              </p>
            </div>

            <div>
              <h3 className="font-semibold text-slate-900 mb-2">Use Planning Tools</h3>
              <p>
                Our online retirement calculators can help you estimate your retirement needs and determine whether
                you're on track to meet your goals.
              </p>
            </div>
          </div>

          <Button className="mt-8 bg-blue-600 hover:bg-blue-700">Schedule a Consultation</Button>
        </div>
      </SectionWrapper>
    </div>
  );
