...
export default async function EnrollmentChecklistPage() {
  const slug = await getEmployerSlug();
  const content = await getPublishedContent(slug);
  const typedData = content.enrollmentChecklist;
          ...
          <div className="space-y-4">
            <div className="p-4 bg-white border border-slate-200 rounded-lg">
              <p className="text-sm text-slate-600 mb-2">
                <strong>Questions about plans?</strong> Our Benefits Assistant can help answer questions about coverage options.
              </p>
            </div>
            ...
            <div className="p-4 bg-white border border-slate-200 rounded-lg">
              <p className="text-sm text-slate-600 mb-2">
                <strong>Provider networks?</strong> Check the plan details to verify your preferred providers are covered.
              </p>
            </div>
          </div>
        </div>
