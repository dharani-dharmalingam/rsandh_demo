...
import type { DocumentData } from '@/lib/content/types';
              ...
              <div className="space-y-3">
                {documents.map((doc: DocumentData) => (
                  ...
                  >
                    ...
                    {doc.fileUrl && (
                      <Button asChild size="sm" className="bg-blue-600 hover:bg-blue-700 ml-4">
              ...
              <div className="p-6 border border-slate-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Detailed plan summaries, SPDs, and coverage documents</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 border border-slate-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Open enrollment guides and enrollment instructions</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 border border-slate-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Annual notices, privacy notices, and compliance documents</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 border border-slate-200 rounded-lg hover:shadow-md transition-shadow cursor-pointer group">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Enrollment forms, beneficiary forms, and claims forms</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <SectionWrapper className="bg-slate-50">
        <div className="max-w-3xl p-8 bg-white rounded-lg border border-slate-200">
          ...
          <p className="text-slate-600 mb-6">
            Our Benefits Assistant can help you locate documents or answer questions about our benefits. Use the chat button in the bottom right corner to get started.
          </p>
